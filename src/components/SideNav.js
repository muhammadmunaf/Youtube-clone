...
export default function SideNav(props) {
    return (
        <nav
            style={{
                width: props.isExtended ? "15rem" : "4.5rem",
                /* overflowY: "hidden", */
            }}
        >
            <div
            ...
            >
                ...
                <div className="navSection">
                    ...
                    <SideNavItem
                        ...
                        linkIcon={YourVidIcon}
                    />
                    <SideNavItem
                        linkText="Watch Later"
                        linkIcon={WatchLaterIcon}
                    />
                    <SideNavItem
                        linkText="Liked Videos"
                        linkIcon={LikedVideos}
                    />
                ...
                <div className="navSection">
                    ...
                    />
                    <SideNavItem
                        linkText="Show 41 More"
                        linkIcon={ShowMoreIcon}
                    />
                </div>
                <div className="navSection">
            ...
            <div
                className="minimized"
                style={{
                    display: props.isExtended ? "none" : "block",
                }}
            >
                <SideNavItem
                    linkText="Home"
                ...
                <SideNavItem linkText="Library" linkIcon={LibIcon} type="Min" />
            </div>
        </nav>
    );
}
